...
function testVersionString() {
  ...
  const hasPhase8 = content.includes('"phase8"') || content.includes("'phase8'");
  results.push({
    name: "Version endpoint reports phase8",
    passed: hasPhase8,
    details: hasPhase8 ? "Version is phase8" : "Version is NOT phase8 — stale string",
  });
}
